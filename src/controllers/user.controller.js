...
const logoutUser = asyncHandler(async(req,res)=>{
    ...
    await User.findOneAndReplace(  req.user._id,
        {
            $set: {
...
const refershAccessToken = asyncHandler(async(req,res)=>{
      ...
      try {
          ...
          if(incomingRefreshToken!==useDeferredValue.refreshToken){
...
const updateUserAvatar = asyncHandler(async(req, res)=>{
        ...
        const avatarLocalPath = await user.file?.path
...
const updateUserCoverImage = asyncHandler(async(req, res)=>{
        ...
        const coverImageLocalPath = await user.file?.path
        ...
        return res.status(200).json(
            new ApiResponse(200, "CoverImage is uploaded successfully")
        )
})
